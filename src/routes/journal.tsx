...
export const Route = createFileRoute("/journal")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Articles, case studies and news from the WebXIA studio.",
      },
      { property: "og:title", content: "Journal — WebXIA" },
      { property: "og:description", content: "Field notes from the studio." },
      { property: "og:url", content: "https://webxia-elevate-ui.lovable.app/journal" },
    ],
    links: [{ rel: "canonical", href: "https://webxia-elevate-ui.lovable.app/journal" }],
  }),
  component: JournalPage,
});

type Filter = "all" | ArticleCategory;
const filters: Filter[] = ["all", "article", "case-study", "news"];
                ...
                >
                  ...
                  <div className="p-6">
                    <div className="flex items-center gap-2 text-xs text-muted-foreground">
                      ...
                      <span>·</span>
                      <span>{a.readingMinutes} {t("journal.minutes")}</span>
                    </div>
