...
const translations: Record<Locale, Dict> = {
  en: {
    ...
    "form.namePh": "Alex Morgan",
    "form.emailPh": "alex@company.com",
    "form.companyPh": "Your company",
    "form.messagePh": "Describe your project, timeline and budget…",
    "form.submit": "Send message",
    "form.submitting": "Sending…",
    "form.success": "Message sent! We'll get back to you within one business day.",
    "form.sent": "Sent!",
    "form.error.send": "Sending failed. Please try again.",
    "form.directEmail": "Email us directly.",
    "form.error.required": "This field is required",
    "form.error.nameMin": "Please enter at least 2 characters",
    "form.error.email": "Please enter a valid email address",
    "form.error.messageMin": "Please enter at least 10 characters",
    ...
    "footer.contact.address": "101 cours de la Marne, 33800 Bordeaux",
    "footer.contact.email": "webxia@protonmail.com",
    "footer.contact.phone": "06 50 67 30 25",
    ...
    "chat.error.generation": "Webi couldn't generate a reply. Please try again.",
    "chat.error.generation.title": "Generation failed",
    "chat.error.timeout": "The request took too long. Please try again.",
    "chat.error.timeout.title": "Request timed out",
    "chat.error.stopped": "Response stopped.",
    "chat.stop": "Stop the response",
    "chat.retry": "Retry",
    ...
    "chat.code.plain": "Code",
    "chat.code.copy": "Copy code",
    "chat.response.copy": "Copy response",
    "chat.copy.done": "Copied",
    "chat.status.writing": "Webi is writing.",
    "chat.scroll.bottom": "Back to bottom",
    ...
    "booking.openInNewTab": "Open in a new tab",
    "booking.fallback": "The calendar could not be loaded inline.",
    "booking.cta": "Book a 30-min call",
    "booking.retry": "Try again",
    "booking.notice": "Hosted by Cal.com — the calendar only loads after your click.",
    ...
    "marquee.pause": "Pause animations",
    "marquee.play": "Play animations",
    ...
    "admin.common.closeMenu": "Close menu",
    "admin.common.retry": "Retry",
    "admin.common.deleted": "Deleted successfully.",
    "admin.common.deleteError": "Delete failed. Please try again.",
    "admin.common.loadError": "Loading failed. Please try again.",
    ...
    "admin.articles.count": "{count} article(s)",
    "admin.nav.messages": "Messages",
    "admin.messages.title": "Messages",
    "admin.messages.description": "Briefs received via the contact form.",
    "admin.messages.search": "Search name, email, message...",
    "admin.messages.filterStatus": "Status",
    "admin.messages.filterAll": "All",
    "admin.messages.filterNew": "New",
    "admin.messages.filterRead": "Read",
    "admin.messages.colMessage": "Message",
    "admin.messages.colStatus": "Status",
    "admin.messages.colReceived": "Received",
    "admin.messages.colActions": "Actions",
    "admin.messages.empty": "No messages yet.",
    "admin.messages.emptyFiltered": "No messages match your filters.",
    "admin.messages.prev": "Previous",
    "admin.messages.next": "Next",
    "admin.messages.deleteConfirm": "Delete this message?",
    "admin.messages.deleteDesc": "This action cannot be undone.",
    "admin.messages.deleteCancel": "Cancel",
    "admin.messages.deleteAction": "Delete",
    "admin.messages.count": "{count} message(s)",
    ...
    "admin.messages.expand": "Show full message",
    "admin.messages.collapse": "Hide full message",
    ...
    "admin.realisations.count": "{count} project(s)",
    ...
    "admin.aiMemory.knowledge": "Knowledge",
    "admin.aiMemory.preference": "Preference",
    "admin.aiMemory.sessions": "sessions",
    "admin.aiMemory.count": "{count} entries",
    "admin.aiMemory.fKey": "Key",
    "admin.aiMemory.fType": "Type",
    "admin.aiMemory.fValue": "Value (JSON)",
    "admin.aiMemory.fMeta": "Metadata",
    "admin.aiMemory.total": "Total memories",
    "admin.aiMemory.byType": "By type",
    "admin.aiMemory.search": "Search by key...",
    "admin.aiMemory.filters": "Filters",
    "admin.aiMemory.sessionCol": "Session",
    "admin.aiMemory.prev": "Previous",
    "admin.aiMemory.next": "Next",
    "admin.aiMemory.deleteSession": "Delete session",
    "admin.aiMemory.deleteSessionDesc": "This will delete all memories of this session.",
    "admin.form.content": "Content",
    "admin.form.settings": "Settings",
    "admin.form.links": "Links",
    "admin.form.seo": "SEO",
    "admin.form.newArticle": "New article",
    "admin.form.editArticle": "Edit article",
    "admin.form.newRealisation": "New project",
    "admin.form.editRealisation": "Edit project",
    "admin.form.title": "Title *",
    "admin.form.slug": "Slug",
    "admin.form.excerpt": "Excerpt",
    "admin.form.contentMd": "Content (Markdown) *",
    "admin.form.shortDescription": "Short description",
    "admin.form.descriptionMd": "Description (Markdown) *",
    "admin.form.status": "Status",
    "admin.form.draft": "Draft",
    "admin.form.published": "Published",
    "admin.form.archived": "Archived",
    "admin.form.tags": "Tags (comma-separated)",
    "admin.form.categories": "Categories (comma-separated)",
    "admin.form.readingMinutes": "Reading time (minutes)",
    "admin.form.cover": "Cover image (URL)",
    "admin.form.metaTitle": "Meta title",
    "admin.form.metaDescription": "Meta description",
    "admin.form.create": "Create",
    "admin.form.save": "Save",
    "admin.form.client": "Client",
    "admin.form.projectUrl": "Project URL",
    "admin.form.gallery": "Image gallery",
    "admin.form.featured": "Featured",
    "admin.form.sortOrder": "Display order",
    ...
    "admin.common.saveError": "Save failed. Please try again.",
    "admin.common.unsavedTitle": "Unsaved changes",
    "admin.common.unsavedDesc": "You have unsaved changes. Leave without saving?",
    "admin.common.unsavedStay": "Stay",
    "admin.common.unsavedLeave": "Leave",
    "admin.login.title": "Sign in",
    "admin.login.subtitle": "Access the WebXIA administration",
    ...
    "admin.login.redirecting": "Redirecting to sign in...",
    ...
    "admin.nav.userMenu": "Account menu",
    "admin.breadcrumb.new": "New",
    "admin.breadcrumb.edit": "Edit",
    "admin.articles.description": "Create and publish your journal articles.",
    "admin.articles.emptyFiltered": "No articles match your filters.",
    "admin.articles.notFound": "Article not found",
    "admin.articles.notFoundDesc": "This article does not exist or has been deleted.",
    "admin.realisations.description": "Manage your client projects and portfolio.",
    "admin.realisations.emptyFiltered": "No projects match your filters.",
    "admin.realisations.notFound": "Project not found",
    "admin.realisations.notFoundDesc": "This project does not exist or has been deleted.",
    "admin.aiMemory.emptyFiltered": "No memories match your filters.",
    "admin.dashboard.recentArticles": "Recent articles",
    "admin.dashboard.recentRealisations": "Recent projects",
    "admin.dashboard.noArticles": "No articles yet.",
    "admin.dashboard.noArticlesCta": "Create your first article",
    "admin.dashboard.noRealisations": "No projects yet.",
    "admin.dashboard.noRealisationsCta": "Create your first project",
  },
  fr: {
    "nav.home": "Accueil",
    "nav.services": "Services",
    ...
    "form.namePh": "Marie Dupont",
    "form.emailPh": "marie@entreprise.fr",
    "form.companyPh": "Votre entreprise",
    "form.messagePh": "Décrivez votre projet, vos délais et votre budget…",
    "form.submit": "Envoyer le message",
    "form.submitting": "Envoi…",
    "form.success": "Message envoyé ! Nous revenons vers vous sous un jour ouvré.",
    "form.sent": "Envoyé !",
    "form.error.send": "L'envoi a échoué. Veuillez réessayer.",
    "form.directEmail": "Écrivez-nous directement.",
    "form.error.required": "Ce champ est requis",
    "form.error.nameMin": "Veuillez saisir au moins 2 caractères",
    "form.error.email": "Veuillez saisir une adresse e-mail valide",
    "form.error.messageMin": "Veuillez saisir au moins 10 caractères",
    ...
    "chat.error.generation": "Webi n'a pas pu générer de réponse. Réessayez.",
    "chat.error.generation.title": "Échec de la génération",
    "chat.error.timeout": "La requête a pris trop de temps. Réessayez.",
    "chat.error.timeout.title": "Requête expirée",
    "chat.error.stopped": "Réponse interrompue.",
    ...
    "chat.response.copy": "Copier la réponse",
    "chat.copy.done": "Copié",
    "chat.status.writing": "Webi écrit.",
    "chat.scroll.bottom": "Revenir en bas",
    ...
    "booking.openInNewTab": "Ouvrir dans un nouvel onglet",
    "booking.fallback": "Le calendrier n'a pas pu se charger ici.",
    "booking.cta": "Réserver 30 min",
    "booking.retry": "Réessayer",
    "booking.notice": "Hébergé par Cal.com — le calendrier ne se charge qu'après votre clic.",
    ...
    "marquee.pause": "Mettre les animations en pause",
    "marquee.play": "Reprendre les animations",
    ...
    "admin.nav.logoutError": "Échec de la déconnexion. Réessayez.",
    "admin.nav.administration": "Administration",
    "admin.dashboard.title": "Vue d'ensemble",
    "admin.dashboard.subtitle": "Pilotez vos contenus et la mémoire IA en un coup d'œil.",
    ...
    "admin.dashboard.content": "Répartition du contenu",
    "admin.dashboard.totalArticles": "Total articles",
    ...
    "admin.common.openMenu": "Ouvrir le menu",
    "admin.common.closeMenu": "Fermer le menu",
    "admin.common.retry": "Réessayer",
    "admin.common.deleted": "Supprimé avec succès.",
    "admin.common.deleteError": "Échec de la suppression. Réessayez.",
    "admin.common.loadError": "Échec du chargement. Réessayez.",
    "admin.articles.title": "Articles",
    ...
    "admin.nav.messages": "Messages",
    "admin.messages.title": "Messages",
    "admin.messages.description": "Briefs reçus via le formulaire de contact.",
    "admin.messages.search": "Rechercher nom, e-mail, message...",
    "admin.messages.filterStatus": "Statut",
    "admin.messages.filterAll": "Tous",
    "admin.messages.filterNew": "Nouveaux",
    "admin.messages.filterRead": "Lus",
    "admin.messages.colMessage": "Message",
    "admin.messages.colStatus": "Statut",
    "admin.messages.colReceived": "Reçu le",
    "admin.messages.colActions": "Actions",
    "admin.messages.empty": "Aucun message pour le moment.",
    "admin.messages.emptyFiltered": "Aucun message ne correspond à vos filtres.",
    "admin.messages.prev": "Précédent",
    "admin.messages.next": "Suivant",
    "admin.messages.deleteConfirm": "Supprimer ce message ?",
    "admin.messages.deleteDesc": "Cette action est irréversible.",
    "admin.messages.deleteCancel": "Annuler",
    "admin.messages.deleteAction": "Supprimer",
    "admin.messages.count": "{count} message(s)",
    "admin.messages.markRead": "Marquer comme lu",
    "admin.messages.markUnread": "Marquer comme non lu",
    "admin.messages.statusNew": "Nouveau",
    "admin.messages.statusRead": "Lu",
    "admin.messages.expand": "Voir le message complet",
    "admin.messages.collapse": "Masquer le message complet",
    ...
    "admin.realisations.count": "{count} réalisation(s)",
    ...
    "admin.aiMemory.knowledge": "Connaissances",
    "admin.aiMemory.preference": "Préférences",
    "admin.aiMemory.sessions": "sessions",
    "admin.aiMemory.count": "{count} entrée(s)",
    "admin.aiMemory.fKey": "Clé",
    "admin.aiMemory.fType": "Type",
    "admin.aiMemory.fValue": "Valeur (JSON)",
    "admin.aiMemory.fMeta": "Métadonnées",
    "admin.aiMemory.total": "Total mémoires",
    "admin.aiMemory.byType": "Par type",
    "admin.aiMemory.search": "Rechercher par clé...",
    "admin.aiMemory.filters": "Filtres",
    "admin.aiMemory.sessionCol": "Session",
    "admin.aiMemory.prev": "Précédent",
    "admin.aiMemory.next": "Suivant",
    "admin.aiMemory.deleteSession": "Supprimer la session",
    "admin.aiMemory.deleteSessionDesc": "Toutes les mémoires de cette session seront supprimées.",
    "admin.form.content": "Contenu",
    "admin.form.settings": "Paramètres",
    "admin.form.links": "Liens",
    "admin.form.seo": "SEO",
    "admin.form.newArticle": "Nouvel article",
    "admin.form.editArticle": "Modifier l'article",
    "admin.form.newRealisation": "Nouvelle réalisation",
    "admin.form.editRealisation": "Modifier la réalisation",
    "admin.form.title": "Titre *",
    "admin.form.slug": "Slug",
    "admin.form.excerpt": "Extrait",
    "admin.form.contentMd": "Contenu (Markdown) *",
    "admin.form.shortDescription": "Description courte",
    "admin.form.descriptionMd": "Description (Markdown) *",
    "admin.form.status": "Statut",
    "admin.form.draft": "Brouillon",
    "admin.form.published": "Publié",
    "admin.form.archived": "Archivé",
    "admin.form.tags": "Tags (séparés par virgules)",
    "admin.form.categories": "Catégories (séparées par virgules)",
    "admin.form.readingMinutes": "Temps de lecture (minutes)",
    "admin.form.cover": "Image de couverture (URL)",
    "admin.form.metaTitle": "Meta titre",
    "admin.form.metaDescription": "Meta description",
    "admin.form.create": "Créer",
    "admin.form.save": "Enregistrer",
    "admin.form.client": "Client",
    "admin.form.projectUrl": "URL du projet",
    "admin.form.gallery": "Galerie d'images",
    "admin.form.featured": "À la une",
    "admin.form.sortOrder": "Ordre d'affichage",
    "admin.form.technologies": "Technologies (séparées par virgules)",
    "admin.common.pageOf": "Page {page} sur {total}",
    "admin.common.deleting": "Suppression...",
    "admin.common.saved": "Enregistré avec succès.",
    "admin.common.saveError": "Échec de l'enregistrement. Réessayez.",
    "admin.common.unsavedTitle": "Modifications non enregistrées",
    "admin.common.unsavedDesc":
      "Vous avez des modifications non enregistrées. Quitter sans enregistrer ?",
    "admin.common.unsavedStay": "Rester",
    "admin.common.unsavedLeave": "Quitter",
    "admin.login.title": "Connexion",
    "admin.login.subtitle": "Accédez à l'administration WebXIA",
    "admin.login.email": "Email",
    ...
    "admin.login.redirecting": "Redirection vers la connexion...",
    "admin.common.loading": "Chargement...",
    "admin.common.back": "Retour",
    "admin.common.viewAll": "Voir tout",
    "admin.common.clearFilters": "Réinitialiser les filtres",
    "admin.nav.viewSite": "Voir le site",
    "admin.nav.collapseSidebar": "Réduire la barre latérale",
    "admin.nav.expandSidebar": "Développer la barre latérale",
    "admin.nav.userMenu": "Menu du compte",
    "admin.breadcrumb.new": "Nouveau",
    "admin.breadcrumb.edit": "Modifier",
    "admin.articles.description": "Créez et publiez vos articles de journal.",
    "admin.articles.emptyFiltered": "Aucun article ne correspond à vos filtres.",
    "admin.articles.notFound": "Article introuvable",
    "admin.articles.notFoundDesc": "Cet article n'existe pas ou a été supprimé.",
    "admin.realisations.description": "Gérez vos projets clients et votre portfolio.",
    "admin.realisations.emptyFiltered": "Aucune réalisation ne correspond à vos filtres.",
    "admin.realisations.notFound": "Réalisation introuvable",
    "admin.realisations.notFoundDesc": "Cette réalisation n'existe pas ou a été supprimée.",
    "admin.aiMemory.emptyFiltered": "Aucune mémoire ne correspond à vos filtres.",
    "admin.dashboard.recentArticles": "Derniers articles",
    "admin.dashboard.recentRealisations": "Dernières réalisations",
    "admin.dashboard.noArticles": "Aucun article pour le moment.",
    "admin.dashboard.noArticlesCta": "Créer votre premier article",
    "admin.dashboard.noRealisations": "Aucune réalisation pour le moment.",
    "admin.dashboard.noRealisationsCta": "Créer votre première réalisation",
  },
};
