...
const translations: Record<Locale, Dict> = {
  ...
  fr: {
    ...
    "about.title": "Une équipe restreinte et senior — obsédée par l'exécution.",
    "about.subtitle": "Nous opérons comme votre équipe produit interne : stratégie, design, ingénierie, IA. Sans couches, sans relais.",
    "about.manifesto.title": "Notre manifeste",
    "about.manifesto.body": "WebXIA existe parce que la majorité du travail digital est moyenne. Nous sommes faits pour les équipes qui la refusent — celles qui mesurent le succès en produits livrés, en utilisateurs réels et en revenus cumulés.",
    "about.values.title": "Nos convictions",
    "about.values.1.title": "Le craft est un levier",
    "about.values.1.desc": "Le détail se cumule. Le 1 % sur chaque écran fait la différence entre oubliable et inévitable.",
    "about.values.2.title": "Livrer pour apprendre",
    "about.values.2.desc": "Nous déployons en semaines, pas en trimestres. Les vrais utilisateurs enseignent plus vite qu'une roadmap.",
    "about.values.3.title": "Peu de clients, travail profond",
    "about.values.3.desc": "Quelques partenaires par trimestre. Vous avez nos meilleurs profils, pas une équipe junior.",
    "about.values.4.title": "Honnête par défaut",
    "about.values.4.desc": "Périmètre cadré, prix transparents, aucune facture surprise. Les conversations difficiles tôt, jamais tard.",
    "about.team.title": "L'équipe",
    "about.process.title": "Notre méthode",
    "about.process.1.title": "Cadrage",
    "about.process.1.desc": "Une semaine. On aligne les objectifs, l'audience, les contraintes et les indicateurs.",
    "about.process.2.title": "Design",
    "about.process.2.desc": "Design system éditorial, motion, prototype. Validé avec de vrais utilisateurs.",
    "about.process.3.title": "Build",
    "about.process.3.desc": "Du code de production dès la première semaine. TypeScript, runtime edge, typé de bout en bout.",
    "about.process.4.title": "Lancement & croissance",
    "about.process.4.desc": "Nous ne disparaissons pas au lancement. Analytics, SEO et itération inclus.",
    "about.stack.title": "Notre stack par défaut",
    "about.location": "Paris · Remote dans ±3h",
    ...
    "home.cta.body": "Nous répondons sous un jour ouvré. Décrivez votre périmètre et votre calendrier.",
