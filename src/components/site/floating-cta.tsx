...
export function FloatingCTA() {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.97 }}
      className="group fixed bottom-6 right-6 z-40 inline-flex items-center gap-2 rounded-full bg-foreground py-3 pl-3 pr-5 text-sm font-medium text-background shadow-[0_20px_50px_-12px_color-mix(in_oklab,var(--foreground)_60%,transparent)]"
    >
